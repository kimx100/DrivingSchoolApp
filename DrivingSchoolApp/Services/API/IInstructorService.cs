...
public interface IInstructorService
{
    ...
    Task<RestResponse<List<InstructorDto>>> GetAllInstructorsAsync();
    Task<RestResponse<InstructorDto>> GetInstructorByIdAsync(Guid instructorId);
    ...
    Task<RestResponse<List<TheoryLessonDto>>> GetTheoryLessonsAsync(Guid instructorId);
    Task<RestResponse<DrivingLessonDto>> CreateDrivingLessonAsync(Guid instructorId,
        DrivingLessonRegistryDto registryDto);

    Task<RestResponse<List<DrivingLessonDto>>> GetDrivingLessonsAsync(Guid instructorId);
}